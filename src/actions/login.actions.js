...
export const register = (fullName, email, phoneNumber, companyName, address) => async (dispatch) => {
  dispatch({ type: USER_REGISTER_REQUEST, payload: { fullName, email, phoneNumber, companyName, address } });
  try {
